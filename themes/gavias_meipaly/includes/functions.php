<?php
function gavias_meipaly_render_block($key) {
...
function gavias_meipaly_makeid($length = 5){
...
function gavias_meipaly_base_url(){
  global $base_url;
...
function gavias_meipaly_preprocess_node(&$variables) {
  global $gva_node_index;
  ...
  $variables['theme_uri'] = base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_meipaly');

}

function gavias_meipaly_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function gavias_meipaly_preprocess_node__event(&$variables){
  $node = $variables['node'];
  $event_date = array();
...
function gavias_meipaly_preprocess_breadcrumb(&$variables){

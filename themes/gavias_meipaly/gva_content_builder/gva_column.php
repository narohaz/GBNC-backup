         ...
         'key'    => 'gva_column',
          ...
          array(
            ...
            array(
               ...
               'options'    => array(
                  ''                 => 'Default',
                  'column-margin-1'       => 'Style 1: Extend content to top & right',
                  'column-style-1'        => 'Style 2: max-with 700px, float left, padding responsive',
                  'column-style-2'        => 'Style 3: max-with 700px, float right, padding responsive',
                  'column-style-3'        => 'Style 4: max-with 600px, float left, padding responsive',
                  'column-box-shadow'     => 'Style 5: Box Shadow',
                  'column-box-shadow-2'   => 'Style 6: Box Shadow & Padding',
                  'column-padding-1'      => 'Style 7: Padding & background white',
               )
            ),
		      array(
		        'id'      => 'el_class',

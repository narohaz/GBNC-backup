    ...
    attach: function (context, settings) {
      $(".geolocation-html5-button:not(.disabled)").each(function (index) {
        ...
        if (latDefault.length > 1 && lngDefault.length > 1) {
          ...
          // Display a location.
          var locationString = Drupal.t("Browser location: @lat,@lng", {
            "@lat": latDefault,
            "@lng": lngDefault,
          });
    ...
    if (navigator.geolocation) {
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        function (position) {
          ...
          var locationString = Drupal.t(
            "Browser location: @lat,@lng Accuracy: @accuracy m",
        ...
        function (error) {
          ...
          switch (error.code) {
            case error.PERMISSION_DENIED:
              alert(
                Drupal.t("No location data found. Reason: PERMISSION_DENIED.")
              );
              break;
            ...
            case error.POSITION_UNAVAILABLE:
              alert(
                Drupal.t(
                  "No location data found. Reason: POSITION_UNAVAILABLE."
                )
              );
              break;

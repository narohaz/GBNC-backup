    ...
    $(document).ready(function () {
        ...
        function enhanceGlassEffect() {
            ...
            $(window).on('scroll', function () {
                ...
                // 应用透明度变化
                $('.glass-effect-bg').css('background-color', 'rgba(255, 255, 255, ' + opacity + ')');
            });
        ...
        function enhanceMobileNavigation() {
            ...
            $('#menu-bar').on('click', function () {
                $('.gva-offcanvas-mobile').toggleClass('open-offcanvas');
        ...
        function initNavigation() {
            ...
            $('.menu-link').on('click', function () {
                ...
                localStorage.setItem('lastNavItem', $(this).find('.menu-title').text());
            });
        }

...
document.addEventListener('DOMContentLoaded', function() {
		...
		const teamModals = document.querySelectorAll('.gbnc-team-modal');
		const closeButtons = document.querySelectorAll('.gbnc-modal-close');
		...
		teamCards.forEach(card => {
			card.addEventListener('click', function() {
				...
				teamModals.forEach(modal => {
					if (modal.getAttribute('data-member-id') === memberId) {

...
;
document.addEventListener('DOMContentLoaded', function () { // 获取所有团队卡片和弹窗元素
const teamCards = document.querySelectorAll('.gbnc-team-card');
const modalContainer = document.querySelector('.gbnc-team-modal-container');
const modalClose = document.querySelector('.gbnc-modal-close');
...
// 填充弹窗内容
const modalName = document.querySelector('.gbnc-modal-name');
const modalProfile = document.querySelector('.gbnc-modal-profile');
const modalImg = document.querySelector('.gbnc-modal-image img');

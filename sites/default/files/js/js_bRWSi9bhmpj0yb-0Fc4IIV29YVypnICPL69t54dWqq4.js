...
;
const btn = document.getElementById('edit-actions');

btn.style?.border-right = ''; //删除按钮右侧红色线条
btn.style?.background = "#163e64"; //改为深蓝色背景 符合主颜色
btn.style?.border-radius = 30px; //改为圆角 感觉不那么商务;
/**
 * @file
 * Progress bar.
 */
